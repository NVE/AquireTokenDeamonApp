...
namespace TestDeamonApp
{
	...
	public class ProtectedApiCallHelper
    {
        ...
        public async Task CallWebApiAndProcessResultASync(AuthenticationConfig config, string webApiUrl, string accessToken, Action<string> processResult)
        {
            if (!string.IsNullOrEmpty(accessToken))
            {
                ...
                defaultRequestHeaders.Add("regObs_apptoken", config.RegObsApptoken); // this is RegobsAPI specific
